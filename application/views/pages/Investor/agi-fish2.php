                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">Kolam</h3>                                
                                    <div class="box-tools pull-left">
                                        <a href="#" class="btn btn-success">Create Kolam</a>
                                    </div>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                                    ...
                                    <table id="agiUser" class="table table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                <th>Status Tambak</th>
                                                <th>Progress Tambak</th>
                                                <th>Nama Kolam</th>
                                                <th>Foto</th>
                                                <th>Lokasi</th>
                                                <th>Total Investasi</th>
                                                <th>Temporary Investasi</th>
                                                <th>Deskripsi Tambak</th>
                                        ...
                                        <tbody>
                                            <?php
                                            foreach ($agiTambak->result() as $row) {
                                                echo "<tr>";
                                                    echo "<td>";
                                                        if ($row->statusTambak == 1) {
                                                            echo "Aktif";
                                                        }else{
                                                            echo "Prosess Investasi";
                                                        }
                                                    echo "</td>";
                                                    echo "<td>";
                                                    ...
                                                    echo "</td>";
                                                    echo "<td>";
                                                        echo $row->pictureTambak;
                                                    echo "</td>";
                                                    echo "<td>";
                                                        echo $row->location;
                                                    echo "</td>";
                                                    echo "<td>";
                                                        echo $row->totalInvestment;
                                                    echo "</td>";
                                                    echo "<td>";
                                                        echo $row->temporaryInvestment;
                                                    echo "</td>";
                                                    echo "<td>";
                                                        echo $row->descriptionTambak;
                                                    echo "</td>";
                                                    echo "<td>";
                                                        echo $row->date;
                                                    echo "</td>";
                                                    ...
                                                    echo "</td>";
                                                    echo "<td>";
                                                        echo $row->pictureFishFarmer;
                                                    echo "</td>";
                                                    echo "<td>";
                                                        echo $row->spaciousPond;
                                                    echo "</td>";
                                                    echo "<td>";
                                                        echo $row->ekspectedPanen;
                                                    echo "</td>";
                                                    echo "<td>";
                                                        echo "<a href='#' style='text-align: right;'class='btn btn-info' type='button'> <i class='glyphicon glyphicon-pencil'></i></a>";
                                                     echo "</td>";
                                                    echo "<td>";
                                                        echo "<a href='#' style='text-align: right;'class='btn btn-danger' type='button'> <i class='glyphicon glyphicon-remove'></i></a>";
                                                    echo "</td>";
                                                echo "</tr>";
                                            }
                                            ?>
