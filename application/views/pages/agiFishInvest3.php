                        ...
                        <div class="col-md-12 section-heading text-center">
                            ...
                            <div class="row">
                                <div class="col-md-8 col-md-offset-2 subtext">
                                    <img class="to-animate img-responsive"src="<?php echo base_url();?>assets/images/agiStep_3.png">
                                </div>
                            </div>
                        </div>
                    </div>
                    <form action="<?php echo site_url('AgiFishInvest/finish');?>" method="post" class="to-animate">
                        <div class="row">
                            <div class="col-md-12">
                                <h3 class="to-animate" style="text-align: center;">Detail Investasi</h3>
                                <hr class="to-animate" style="margin-top: -20px;">
                                <div class="to-animate" style="text-align: center;">
                                     Mohon transfer ke rekening berikut untuk menyelesaikan transaksi anda sejumlah         <br><br>
                                    <h2><b>Rp. <?php
                                    echo number_format($modalInvestasi);?></b></h2><br>
                                    <h3>Rekening Pembayaran</h3>
                                </div>
                                <div class="row">
                                    <div class="to-animate col-md-12" style="text-align: center;">
                                        <img alt="logo BCA" style="width: 172px; height: 80px; text-align: center"src="<?php echo base_url();?>assets/images/Investment/logoBCA.jpg"><br>
                                            <b>BCA</b><br>
                                            No Rek<br><b>6019 0055 0517 6516</b><br>
                        ...
                        <input type="hidden" name="total_investTambak" id="total_investTambak" value="<?php echo $total_investTambak;?>">
                                    ...
                                    <b>SMS</b>: +62083873767405 (Helfi) atau<br><b>Email</b> : care@agivest.com<br><br>
                                    <b style="font-style:italic">*Maksimal konfirmasi adalah H+3, jika lewat dari itu maka transaksi akan dihapus (dianggap membatalkan pembelian)</b><br><br><br>
