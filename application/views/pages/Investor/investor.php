                    ...
                    <div class="row">
                        <div class="col-lg-6 col-xs-6">
                            ...
                            <div class="small-box bg-blue">
                                ...
                                <a href="<?php echo site_url('Investor/agiFish'); ?>" class="small-box-footer">Lihat <i class="fa fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                        <!-- ./col -->
                        <div class="col-lg-6 col-xs-6">
                        ...
                        <div class="col-md-12">
                            <div class="box box-info">
                                ...
                                <div class="box-footer clearfix">
                                    <a href="javascript:void(0)" class="btn btn-sm btn-info btn-flat pull-left">Investasi kembali</a>
                                    <a href="javascript:void(0)" class="btn btn-sm btn-default btn-flat pull-right">Lihat semua order</a>
                                </div>
                                <!-- /.box-footer -->
                            </div>
                        </div>
